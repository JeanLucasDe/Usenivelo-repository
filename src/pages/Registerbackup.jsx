...
const RegisterPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Cadastro - FlexiSaaS</title>
        <meta name="description" content="Crie sua conta FlexiSaaS e comece a transformar sua gestão empresarial hoje mesmo." />
      </Helmet>
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-bold text-gradient">FlexiSaaS</span>
            </div>
