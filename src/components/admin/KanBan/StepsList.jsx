...
<div className="flex justify-between items-center mb-3">
  <h3 className="font-medium text-lg">{etapa.name}</h3>
...
{etapa.usuarios.length > 0 ? (
  ...
  <p className="text-sm text-gray-500 italic">Nenhum usuário nesta etapa</p>
)}
